  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="resume.php"><span class="selection">Resume</span></a></li>

        <li><a href="Contact.php"><span class="selection">Contact</span></a></li>
...
<div class="container" >
<div class="res">
  <h2>Take a look at my resume to learn some more</h2>
  </div>
     <div class="pos">
      
  <button class="btn-lg ">
  <a target="button" href="PatrickBoucicaultResume.pdf">
  Download Resume</a>
</button>
     </div>
